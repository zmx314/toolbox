...
public class QRCodeUtil {
    ...
    public static void createCodeToFile(String content, File dir, String fileName) {
        try {
            ...
            File codeImgFile = new File(dir, fileName);
    ...
    /**
     * 生成二维码并输出到输出流, 通常用于输出到网页上进行显示，输出到网页与输出到磁盘上的文件中.
     * 区别在于最后一句 ImageIO.write()
     * ImageIo.write(RenderedImage im,String formatName,File output)：写到文件中
     * Image.write(RenderedImage im,String formatName,OutputStream output)：输出到输出流中
     *
     * @param content      ：二维码内容
